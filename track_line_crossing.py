        ...
        for i, det in enumerate(pred):  # detections per image
                    ...
                    for j, (output, conf) in enumerate(zip(outputs[i], confs)):
                        ...
                        if save_vid or save_crop or show_vid:  # Add bbox to image
                            ...
                            if iou_conf > 0.1:
                                ...
                                annotator.box_label(bboxes, iou_conf,unique_tyre_centroid[tyre_id]["isLoaded"], label, color=colors(c, True))
                            if save_crop:
            ...
            if save_vid:
                if vid_path[i] != save_path:  # new video
                    ...
                    if vid_cap:  # video
                        fps = 25 #vid_cap.get(cv2.CAP_PROP_FPS)
